...
function buildAboutCharacterInfo() {
	...
	$(dom.characterAboutInfo).append(`
		<table border="1" width="100%">
			...
			<tr>
				<td>Возраст</td>
				<td>${currentPlayer.age*races.gnome.ageModificator}</td>
			</tr>
			<tr>
				<td>Рост</td>
				<td>${currentPlayer.height}см</td>
			</tr>
			<tr>
				<td>Вес</td>
				<td>${currentPlayer.weight}кг</td>
			</tr>
			<tr>
				<td>Расса</td>
				<td>${currentPlayer.race.raceName}</td>
			</tr>
			<tr>
				<td>Подвид</td>
				<td>${currentPlayer.subRace.subRaceName}</td>
			</tr>
			<tr>
				<td>Характер</td>
	...
	$(dom.characterAbilityScores).append(`
		<table class="bigTable" border="1" cellpadding="1" cellspacing="0">
			...
			<tr border="1px">
				...
				<td>${currentPlayer.strengthMod}</td>
				<td>Атлетика</td>
				<td></td>
				<td>9</td>
			</tr>
			<tr>
				...
				<td rowspan="3">${currentPlayer.dexterity}</td>
				<td rowspan="3">${currentPlayer.dexterityMod}</td>
				<td>Акробатика</td>
				<td></td>
				<td>11</td>
			</tr>
			...
			<tr>
				<td>Телосложение</td>
				<td>${currentPlayer.constitution}</td>
				<td>${currentPlayer.constitutionMod}</td>
				<td>Выносливость</td>
				<td></td>
				<td>12</td>
			</tr>
			<tr>
				...
				<td rowspan="5">${currentPlayer.intelligence}</td>
				<td rowspan="5">${currentPlayer.intelligenceMod}</td>
				<td>Анализ</td>
				<td>2</td>
				<td>15</td>
			</tr>
			...
			<tr>
				...
				<td rowspan="5">${currentPlayer.wisdom}</td>
				<td rowspan="5">${currentPlayer.wisdomMod}</td>
			...
			<tr>
				...
				<td rowspan="4">${currentPlayer.charisma}</td>
				<td rowspan="4">${currentPlayer.charismaMod}</td>
				<td>Выступление</td>
				<td></td>
				<td>10</td>
			</tr>
...
var gremmy = {
	...
	alignment: "Хаот-нейт (ХН)",
	background: "Мудрец",

	imgURL: "https://vignette.wikia.nocookie.net/wow/images/1/18/ChromieTCG.JPG/revision/latest?cb=20140219143258&path-prefix=ru",
